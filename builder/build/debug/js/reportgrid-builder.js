...
Xml.prototype = {
	...
	,nodeType: null
	,__class__: Xml
	,__properties__: {set_nodeName:"set_nodeName",get_nodeName:"get_nodeName",set_nodeValue:"set_nodeValue",get_nodeValue:"get_nodeValue",get_parent:"getParent"}
}
var haxe = {}
haxe.Log = function() { }
...
mconsole.ConsoleView = function() {
	...
	this.atBottom = true;
	this.projectHome = "/Users/francoponticelli/Projects/reportgrid/reportgrid-builder/builder/";
...
var mcore = {}
mcore.data = {}
mcore.data.Dictionary = function(weakKeys) {
	if(weakKeys == null) weakKeys = false;
	this._keys = [];
	this._values = [];
};
$hxClasses["mcore.data.Dictionary"] = mcore.data.Dictionary;
...
mmvc.impl = {}
mmvc.impl.Actor = function() {
};
$hxClasses["mmvc.impl.Actor"] = mmvc.impl.Actor;
mmvc.impl.Actor.__name__ = ["mmvc","impl","Actor"];
mmvc.impl.Actor.prototype = {
	injector: null
	,__class__: mmvc.impl.Actor
}
...
var rg = {}
rg.app = {}
rg.app.ApplicationContext = function(contextView,modules) {
	this.modules = modules;
	mmvc.impl.Context.call(this,contextView);
};
$hxClasses["rg.app.ApplicationContext"] = rg.app.ApplicationContext;
rg.app.ApplicationContext.__name__ = ["rg","app","ApplicationContext"];
rg.app.ApplicationContext.__super__ = mmvc.impl.Context;
rg.app.ApplicationContext.prototype = $extend(mmvc.impl.Context.prototype,{
	shutdown: function() {
	}
	,startup: function() {
		var $it0 = $iterator(this.modules)();
		while( $it0.hasNext() ) {
			var module = $it0.next();
	...
	,modules: null
	,__class__: rg.app.ApplicationContext
});
rg.core = {}
rg.core.IModule = function() { }
$hxClasses["rg.core.IModule"] = rg.core.IModule;
rg.core.IModule.__name__ = ["rg","core","IModule"];
rg.core.IModule.prototype = {
	register: null
	,__class__: rg.core.IModule
}
rg.app.ApplicationModule = function() {
};
$hxClasses["rg.app.ApplicationModule"] = rg.app.ApplicationModule;
rg.app.ApplicationModule.__name__ = ["rg","app","ApplicationModule"];
...
$hxClasses["rg.core.View"] = rg.core.View;
rg.core.View.__name__ = ["rg","core","View"];
rg.core.View.prototype = {
	toString: function() {
		return Type.getClassName(Type.getClass(this)).split(".").pop();
	}
	,removeChild: function(view) {
		if(HxOverrides.remove(this.children,view)) {
	...
	,init: function() {
		if(null == this.element) this.element = new $("<div></div>");
	}
...
rg.app.view.ApplicationView = function(el) {
	this.resize = new msignal.Signal2();
	this.element = el;
	rg.core.View.call(this);
};
$hxClasses["rg.app.view.ApplicationView"] = rg.app.view.ApplicationView;
rg.app.view.ApplicationView.__name__ = ["rg","app","view","ApplicationView"];
rg.app.view.ApplicationView.__interfaces__ = [mmvc.api.IViewContainer];
rg.app.view.ApplicationView.__super__ = rg.core.View;
rg.app.view.ApplicationView.prototype = $extend(rg.core.View.prototype,{
	isAdded: function(view) {
		return true;
	}
	,dispatch: function(event,view) {
		if(event == "added" && null != this.viewAdded) this.viewAdded(view); else if(event == "removed" && null != this.viewRemoved) this.viewRemoved(view); else rg.core.View.prototype.dispatch.call(this,event,view);
	}
	,init: function() {
		var _g = this;
		rg.core.View.prototype.init.call(this);
		this.element.on("resize",function() {
			_g.resize.dispatch(_g.element.innerWidth(),_g.element.innerHeight());
		});
		haxe.Timer.delay(function() {
			new $(_g.element).resize();
		},0);
	}
	,viewRemoved: null
	,viewAdded: null
	,resize: null
	,__class__: rg.app.view.ApplicationView
});
rg.app.view.ApplicationViewMediator = function(size) {
	this.applicationSize = size;
	mmvc.impl.Mediator.call(this);
};
$hxClasses["rg.app.view.ApplicationViewMediator"] = rg.app.view.ApplicationViewMediator;
rg.app.view.ApplicationViewMediator.__name__ = ["rg","app","view","ApplicationViewMediator"];
rg.app.view.ApplicationViewMediator.__super__ = mmvc.impl.Mediator;
rg.app.view.ApplicationViewMediator.prototype = $extend(mmvc.impl.Mediator.prototype,{
	onRemove: function() {
		this.view.resize.remove(($_=this.applicationSize.resize,$bind($_,$_.dispatch)));
		mmvc.impl.Mediator.prototype.onRemove.call(this);
	}
	,onRegister: function() {
		mmvc.impl.Mediator.prototype.onRegister.call(this);
		this.view.addChild(new rg.layout.view.LayoutView());
		this.view.resize.add(($_=this.applicationSize.resize,$bind($_,$_.dispatch)));
	}
	,applicationSize: null
	,__class__: rg.app.view.ApplicationViewMediator
});
rg.builder = {}
rg.builder.BuilderModule = function() {
};
$hxClasses["rg.builder.BuilderModule"] = rg.builder.BuilderModule;
rg.builder.BuilderModule.__name__ = ["rg","builder","BuilderModule"];
rg.builder.BuilderModule.__interfaces__ = [rg.core.IModule];
rg.builder.BuilderModule.prototype = {
	register: function(context) {
	}
	,__class__: rg.builder.BuilderModule
}
rg.core.DebugModule = function() {
	mconsole.Console.start();
};
$hxClasses["rg.core.DebugModule"] = rg.core.DebugModule;
rg.core.DebugModule.__name__ = ["rg","core","DebugModule"];
rg.core.DebugModule.__interfaces__ = [rg.core.IModule];
rg.core.DebugModule.prototype = {
	register: function(context) {
	}
...
rg.layout.view = {}
rg.layout.view.PaneView = function() {
	rg.core.View.call(this);
};
$hxClasses["rg.layout.view.PaneView"] = rg.layout.view.PaneView;
rg.layout.view.PaneView.__name__ = ["rg","layout","view","PaneView"];
rg.layout.view.PaneView.__super__ = rg.core.View;
rg.layout.view.PaneView.prototype = $extend(rg.core.View.prototype,{
	init: function() {
		rg.core.View.prototype.init.call(this);
		this.element.addClass("rgb-pane");
		if(null != this.cls) this.element.addClass(this.cls);
	}
	,cls: null
	,__class__: rg.layout.view.PaneView
});
rg.layout.view.ChartPaneView = function() {
	this.cls = "rgb-pane-chart";
	rg.layout.view.PaneView.call(this);
	this.element.append("<img src=\"images/fake-chart.png\" style=\"max-width:480px;height:240px\">");
};
$hxClasses["rg.layout.view.ChartPaneView"] = rg.layout.view.ChartPaneView;
rg.layout.view.ChartPaneView.__name__ = ["rg","layout","view","ChartPaneView"];
rg.layout.view.ChartPaneView.__super__ = rg.layout.view.PaneView;
...
rg.layout.view.ControlMainPaneView = function() {
	...
	rg.layout.view.PaneView.call(this);
	var box = new rg.widget.DisplayBox("type");
	((function($this) {
		var $r;
		...
		$r = icon;
		return $r;
	}(this))).appendTo(box.addItem("Bar Chart").context);
	this.element.append(box.element);
	var box1 = new rg.widget.DisplayBox("x");
	((function($this) {
		var $r;
		var icon = (function($this) {
			var $r;
		...
		$r = icon;
		return $r;
	}(this))).appendTo(box1.addItem("Timestamp").context);
	this.element.append(box1.element);
	var box2 = new rg.widget.DisplayBox("y");
	((function($this) {
		var $r;
		var icon = (function($this) {
			var $r;
		...
		$r = icon;
		return $r;
	}(this))).appendTo(box2.addItem("Count").context);
	this.element.append(box2.element);
	var box3 = new rg.widget.DisplayBox("color");
	((function($this) {
		var $r;
		var icon = (function($this) {
			var $r;
		...
		$r = icon;
		return $r;
	}(this))).appendTo(box3.addItem("Browser").context);
	this.element.append(box3.element);
	box3 = new rg.widget.DisplayBox("...");
	((function($this) {
		var $r;
		var icon = (function($this) {
			var $r;
		...
		$r = icon;
		return $r;
	}(this))).appendTo(box3.addItem("&nbsp;").context);
	this.element.append(box3.element);
	box3 = new rg.widget.DisplayBox("dimensions");
	((function($this) {
		var $r;
		var icon = (function($this) {
			var $r;
	...
	((function($this) {
		...
		$r = icon;
		return $r;
	}(this))).appendTo(box3.addItem("OS").context);
	((function($this) {
		var $r;
		var icon = (function($this) {
			var $r;
		...
		$r = icon;
		return $r;
	}(this))).appendTo(box3.addItem("CPM").context);
	((function($this) {
		var $r;
		var icon = (function($this) {
			var $r;
		...
		$r = icon;
		return $r;
	}(this))).appendTo(box3.addItem("TimeStamp").context);
	this.element.append(box3.element);
};
...
rg.layout.view.ControlSecondaryPaneView = function() {
	...
	rg.layout.view.PaneView.call(this);
	this.element.append("<p class=\"rgb-header rgb-display-box-title\">General Options</p>");
	var box = new rg.widget.DisplayBox("size");
	((function($this) {
		var $r;
		var icon = (function($this) {
			var $r;
		...
		$r = icon;
		return $r;
	}(this))).appendTo(box.addItem("480x240").context);
	this.element.append(box.element);
	this.element.append("<p class=\"rgb-header rgb-display-box-title\">Chart Options</p>");
	var box1 = new rg.widget.DisplayBox("effect");
	((function($this) {
		var $r;
		var icon = (function($this) {
			var $r;
		...
		$r = icon;
		return $r;
	}(this))).appendTo(box1.addItem("gradient 1.1").context);
	this.element.append(box1.element);
	var box2 = new rg.widget.DisplayBox("stacked");
	var item = box2.addItem();
	((function($this) {
		var $r;
		var icon = (function($this) {
			var $r;
		...
		$r = icon;
		return $r;
	}(this))).appendTo(item.context);
	var icon1 = (function($this) {
		var $r;
		var icon = (function($this) {
			var $r;
			var w = new $("<" + "i" + " class=\"icon-size" + "-small" + " icon-" + "ok" + "\"></" + "i" + ">");
	...
	icon1.click(function() {
		haxe.Log.trace("clicking",{ fileName : "ControlSecondaryPaneView.hx", lineNumber : 31, className : "rg.layout.view.ControlSecondaryPaneView", methodName : "new"});
		if(icon1.hxw.type == "ok") {
			if("remove" != icon1.hxw.type) {
				icon1.removeClass("icon-" + icon1.hxw.type);
				icon1.hxw.type = "remove";
				icon1.addClass("icon-" + icon1.hxw.type);
			}
			icon1.hxw.type;
		} else {
			if("ok" != icon1.hxw.type) {
				icon1.removeClass("icon-" + icon1.hxw.type);
				icon1.hxw.type = "ok";
				icon1.addClass("icon-" + icon1.hxw.type);
			}
	...
	item.element.append(icon1);
	this.element.append(box2.element);
};
$hxClasses["rg.layout.view.ControlSecondaryPaneView"] = rg.layout.view.ControlSecondaryPaneView;
rg.layout.view.ControlSecondaryPaneView.__name__ = ["rg","layout","view","ControlSecondaryPaneView"];
rg.layout.view.ControlSecondaryPaneView.__super__ = rg.layout.view.PaneView;
rg.layout.view.ControlSecondaryPaneView.prototype = $extend(rg.layout.view.PaneView.prototype,{
	__class__: rg.layout.view.ControlSecondaryPaneView
});
rg.layout.view.LayoutView = function() {
	rg.core.View.call(this);
};
$hxClasses["rg.layout.view.LayoutView"] = rg.layout.view.LayoutView;
rg.layout.view.LayoutView.__name__ = ["rg","layout","view","LayoutView"];
rg.layout.view.LayoutView.__super__ = rg.core.View;
rg.layout.view.LayoutView.prototype = $extend(rg.core.View.prototype,{
	init: function() {
		rg.core.View.prototype.init.call(this);
		this.element.addClass("rg-builder");
	}
	,__class__: rg.layout.view.LayoutView
});
rg.layout.view.LayoutViewMediator = function(size) {
	this.applicationSize = size;
	mmvc.impl.Mediator.call(this);
};
$hxClasses["rg.layout.view.LayoutViewMediator"] = rg.layout.view.LayoutViewMediator;
rg.layout.view.LayoutViewMediator.__name__ = ["rg","layout","view","LayoutViewMediator"];
rg.layout.view.LayoutViewMediator.__super__ = mmvc.impl.Mediator;
rg.layout.view.LayoutViewMediator.prototype = $extend(mmvc.impl.Mediator.prototype,{
	setBoundaries: function(el,x,y,w,h) {
		el.css({ top : y + "px", left : x + "px"});
		el.outerWidth(w).outerHeight(h);
	}
	,resize: function(w,h) {
		var el = this.menuPaneView.element, menuHeight = el.outerHeight(), mainHeight = h - menuHeight;
		this.setBoundaries(el,0,0,w,menuHeight);
		el = this.controlMainPaneView.element;
		var sidebarWidth = el.outerWidth();
		this.setBoundaries(el,0,menuHeight,sidebarWidth,mainHeight);
		el = this.chartPaneView.element;
		this.setBoundaries(el,sidebarWidth,menuHeight,w - sidebarWidth * 2,mainHeight);
		el = this.controlSecondaryPaneView.element;
		this.setBoundaries(el,w - sidebarWidth,menuHeight,sidebarWidth,mainHeight);
	}
	,onRemove: function() {
		this.applicationSize.resize.remove($bind(this,this.resize));
		mmvc.impl.Mediator.prototype.onRemove.call(this);
	}
	,onRegister: function() {
		mmvc.impl.Mediator.prototype.onRegister.call(this);
		this.injector.mapSingleton(rg.layout.view.MenuPaneView);
		this.injector.mapSingleton(rg.layout.view.ControlMainPaneView);
		this.injector.mapSingleton(rg.layout.view.ChartPaneView);
		this.injector.mapSingleton(rg.layout.view.ControlSecondaryPaneView);
		this.view.addChild(this.menuPaneView = this.injector.getInstance(rg.layout.view.MenuPaneView));
		this.view.addChild(this.controlMainPaneView = this.injector.getInstance(rg.layout.view.ControlMainPaneView));
		this.view.addChild(this.chartPaneView = this.injector.getInstance(rg.layout.view.ChartPaneView));
		this.view.addChild(this.controlSecondaryPaneView = this.injector.getInstance(rg.layout.view.ControlSecondaryPaneView));
		this.applicationSize.resize.add($bind(this,this.resize));
	}
	,chartPaneView: null
	,menuPaneView: null
	,controlSecondaryPaneView: null
	,controlMainPaneView: null
	,applicationSize: null
	,__class__: rg.layout.view.LayoutViewMediator
});
rg.layout.view.MenuPaneView = function() {
	this.cls = "rgb-pane-menu";
	rg.layout.view.PaneView.call(this);
};
$hxClasses["rg.layout.view.MenuPaneView"] = rg.layout.view.MenuPaneView;
rg.layout.view.MenuPaneView.__name__ = ["rg","layout","view","MenuPaneView"];
rg.layout.view.MenuPaneView.__super__ = rg.layout.view.PaneView;
rg.layout.view.MenuPaneView.prototype = $extend(rg.layout.view.PaneView.prototype,{
	init: function() {
		rg.layout.view.PaneView.prototype.init.call(this);
		this.bar = twitter.Bootstrap.navbar(this.element);
		this.brand = twitter.JQHelper.create(this.bar,"<a href=\"" + "http://www.reportgrid.com/" + "\" class=\"brand\"" + " target=\"_blank\"" + ">" + "RG Builder" + "</a>");
		this.menu = twitter.JQHelper.create(this.bar,"<ul class=\"nav" + "" + "\"></ul>");
		this.menuContext = twitter.JQHelper.create(this.bar,"<ul class=\"nav" + " pull-right" + "\"></ul>");
	}
	,menuContext: null
	,menu: null
	,brand: null
...
rg.widget = {}
rg.widget.Widget = function() {
	this.init();
};
$hxClasses["rg.widget.Widget"] = rg.widget.Widget;
rg.widget.Widget.__name__ = ["rg","widget","Widget"];
rg.widget.Widget.prototype = {
	...
	,init: function() {
		this.element = new $("<div></div>");
	}
	,element: null
	,__class__: rg.widget.Widget
}
rg.widget.DisplayBox = function(content) {
	rg.widget.Widget.call(this);
	this.element.addClass("rgb-display-box");
	this.label = new $("<div class=\"rgb-label\">" + content + "</div>");
	this.divider = new $("<div class=\"rgb-divider\"><div class=\"rgb-divider-top\"></div><div class=\"rgb-divider-bottom\"></div></div>");
	this.box = new $("<div class=\"rgb-box\"></div>");
	this.element.append(this.label);
	this.element.append(this.divider);
	this.element.append(this.box);
};
$hxClasses["rg.widget.DisplayBox"] = rg.widget.DisplayBox;
rg.widget.DisplayBox.__name__ = ["rg","widget","DisplayBox"];
rg.widget.DisplayBox.__super__ = rg.widget.Widget;
rg.widget.DisplayBox.prototype = $extend(rg.widget.Widget.prototype,{
	addItem: function(content) {
		if(content == null) content = "";
		var item = new rg.widget.DisplayItem(content);
		this.box.append(item.element);
		return item;
	}
	,box: null
	,divider: null
	,label: null
	,__class__: rg.widget.DisplayBox
});
rg.widget.DisplayItem = function(content) {
	rg.widget.Widget.call(this);
	this.element.addClass("rgb-display-item");
	this.context = new $("<div class=\"rgb-item-context\"></div>");
	this.display = new $("<div class=\"rgb-item-display\">" + content + "</div>");
	this.element.append(this.context);
	this.element.append(this.display);
};
$hxClasses["rg.widget.DisplayItem"] = rg.widget.DisplayItem;
rg.widget.DisplayItem.__name__ = ["rg","widget","DisplayItem"];
rg.widget.DisplayItem.__super__ = rg.widget.Widget;
rg.widget.DisplayItem.prototype = $extend(rg.widget.Widget.prototype,{
	context: null
	,display: null
	,__class__: rg.widget.DisplayItem
});
var thx = {}
thx.core = {}
...
twitter.Bootstrap.__name__ = ["twitter","Bootstrap"];
twitter.Bootstrap.dropdown = function(el) {
	return el.dropdown();
}
twitter.Bootstrap.navbar = function(container) {
	var el = new $("<div class=\"navbar\"><div class=\"navbar-inner\"><div class=\"container\"></div></div></div>"), content = el.find("div.container");
	container.append(el);
	return content;
}
twitter.JQHelper = function() { }
$hxClasses["twitter.JQHelper"] = twitter.JQHelper;
twitter.JQHelper.__name__ = ["twitter","JQHelper"];
twitter.JQHelper.create = function(el,html) {
	var newel = new $(html);
	el.append(newel);
	return newel;
}
...
mmvc.impl.Actor.__meta__ = { fields : { injector : { name : ["injector"], type : ["minject.Injector"], inject : null}}};
...
//@ sourceMappingURL=reportgrid-builder.js.map